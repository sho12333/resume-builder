				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
					...
					<div className="bg-card-bg rounded-xl shadow-lg p-6 transition-colors duration-300">
						...
						<button
							...
							className="w-full mt-6 bg-gradient-to-r from-pink-500 to-purple-500 text-white py-3 px-6 rounded-lg font-bold text-lg hover:from-pink-600 hover:to-purple-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
						>
